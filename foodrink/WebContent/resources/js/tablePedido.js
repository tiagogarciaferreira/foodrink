...
function editar(objeto, parametro){
	 ...
	 document.getElementById("solicitacao").href = "editar-pedido?id="+idSelecionado;
	 document.getElementById("solicitacao").click();
}
function verificaRemover(valor){
	if(valor.value == 'SIM'){
		document.getElementById("solicitacao").href = "remover-pedido?id="+removerRegistro;
		document.getElementById("solicitacao").click();
...
function initTablePedido(){
	var listarTodos = document.getElementById("listar").checked;
	$('#tabelaPedido').DataTable({
        ...
        "serverSide": false,
		"ajax": {
        "url": '../pedido/listarPedidosEditar',
        "type": 'GET',
        "data": {listarTodos:listarTodos}
		},
		 "columnDefs": [
			 	{
			      "data": null,
