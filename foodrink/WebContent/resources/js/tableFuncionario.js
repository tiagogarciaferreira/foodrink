...
function editar(objeto, parametro){
	 ...
	 document.getElementById("solicitacao").href = "editar-funcionario?id="+idSelecionado;
...
function verificaRemover(valor){
	if(valor.value == 'SIM'){
		document.getElementById("solicitacao").href = "remover-funcionario?id="+removerRegistro;
		document.getElementById("solicitacao").click();
			...
			.DataTable(
					{
						...
						"serverSide" : false,
						"ajax" : {
							"url" : '../funcionario/listarFuncionariosEditar',
							"type" : 'GET',
							"data" : {
								identificador : "",
								token : ""
