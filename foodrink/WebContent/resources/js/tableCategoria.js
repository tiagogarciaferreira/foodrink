...
function editar(objeto, parametro){
	 ...
	 document.getElementById("solicitacao").href = "editar-categoria?id="+idSelecionado;
...
function verificaRemover(valor){
	if(valor.value == 'SIM'){
		document.getElementById("solicitacao").href = "remover-categoria?id="+removerRegistro;
		document.getElementById("solicitacao").click();
...
function initTableCategoria(){
	...
	$('#tabelaCategoria').DataTable({
        ...
        "serverSide": false,
		"ajax": {
        "url": '../categoria/listarCategoriasEditar', 
        "type": 'GET',
        "data": {}
		},
		 "columnDefs": [
