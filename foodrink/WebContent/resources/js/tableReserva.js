...
function editar(objeto, parametro){
	 ...
	 document.getElementById("solicitacao").href = "editar-reserva?id="+idSelecionado;
	 document.getElementById("solicitacao").click();
}

function verificaRemover(valor){
	if(valor.value == 'SIM'){
		document.getElementById("solicitacao").href = "remover-reserva?id="+removerRegistro;
		document.getElementById("solicitacao").click();
...
function initTableReserva(){
	...
	$('#tabelaReserva').DataTable({
        ...
        "serverSide": false,
		"ajax": {
        "url": '../reserva/listarReservasEditar',
        "type": 'GET',
