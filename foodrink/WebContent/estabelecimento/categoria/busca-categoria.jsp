...
<body id="page-top" class="fundo">
	...
	<div class=" shadow mb-4 invisivel"
		...
		<div class="card-body invisivel" style="border-radius: 5px;">
			...
			<a href="" hidden="true" id="solicitacao"></a> 
				<table class="table table-bordered" id="tabelaCategoria" style="width: 100%; overflow: auto;">
					<thead class="text-center">
						<tr>
							<th style="width: 1px;">ID</th>
							<th style="width: 1px;">Nome</th>
  ...
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript" src="../../resources/js/tableCategoria.js"></script>
</body>
