...
<body id="page-top" class="fundo">
	...
	<div class=" shadow mb-4 invisivel"
		...
		<div class="card-body invisivel" style="border-radius: 5px;">
			...
			<a href="" hidden="true" id="solicitacao"></a> 
				<table class="table table-bordered" id="tabelaPedido"  style="width: 100%; overflow: auto;">
  ...
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript" src="../../resources/js/tablePedido.js"></script>
</body>
