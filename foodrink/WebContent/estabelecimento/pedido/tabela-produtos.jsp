...
<body id="page-top" class="">
	<div class=" shadow mb-4 invisivel"
		...
		<div class="card-body invisivel " style="border-radius: 5px;">
			<div class="table-responsive invisivel">							
				<table class="table table-bordered invisivel" id="tabelaProdutosPedido" style="width: 100%;overflow: auto;">
	...
	<script type="text/javascript" src="../../resources/js/tableProdutoPedido.js"></script>
</body>
