	...
	<div class=" shadow mb-4 invisivel"
		...
		<div class="card-body invisivel" style="border-radius: 5px;">
			...
			<a href="" hidden="true" id="solicitacao"></a> 
				<table class="table table-bordered" id="tabelaAEntregar" style="width: 100%; overflow: auto;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content fundo">
      ...
      <div class="modal-body">
        <p>Realmente deseja marcar o item como entregue?</p>
      </div>
	...
	<script type="text/javascript"
	 ...
	 <script type="text/javascript" src="../../resources/js/table-a-entregar.js"></script>
</body>
