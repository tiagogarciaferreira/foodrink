...
<c:if test="${empty usuario.nome}"> <script type="text/javascript">location.href = 'perfil-cliente'</script></c:if> 
							...
							<div class="col-md-12" style="margin: auto;">
								<div class="p-5">
									...
									<form id="form_novo_cliente" name="form_novo_cliente"
										method="POST" action="atualizar-cliente">
										...
										<fieldset class="border p-3 fildset">
											...
											<div class="form-group" hidden="true">
												<label for="idCliente" class="margembaixo"><span
													class="aviso">*</span></label> <input type="text"
													class="form-control form-control-user" id="idCliente"
													name="idCliente" value="${cliente.idCliente}">
											</div>
											...
											<div class="form-group">
												<label for="cpf" class="margembaixo">Cpf<span
													...
													aria-describedby="cpf" placeholder="Informe seu cpf" value="${cliente.cpf}" readonly="readonly">
											</div>
										...
										<fieldset class="border p-3 fildset">
											...
											<div class="form-group">
												<label for="email" class="margembaixo">Email<span
													...
													placeholder="Informe seu email" value="${usuario.email}" readonly="readonly">
											</div>
										...
										<br>
										<button type="submit"
											class="btn btn-primary btn-user btn-block mao"><i class="fa fa-save"></i> Salvar alterações</button>
									</form>
								</div>
							</div>
						</div>
