...
<body id="page-top" class="fundo">
										...
										<c:forEach  var="empresa" items="${empresa}">
											<div class="col-xl-3 col-md-12 mb-4 ">
												<div class="text-xs mb-0 font-weight-bold text-gray-800"
													...
													<a href="../reserva/cadastro-reserva.jsp?usuarioID=${userLogado.idUsuario}&empresaID=${empresa.idEmpresa}" class="btn btn-outline-primary btn-xs" id="reserva">Reserva</a>
	...
	<script type="text/javascript"
		src="../../resources/js/validacao_menor.js"></script>
