				...
				<div class="row col-md-12 justify-content-center"
					...
					<c:forEach var="categoria" items="${categoria}">
						<div
							...
							<a
								href="produtos-categoria-estabelecimento?categoriaID=${categoria.idCategoria}"
								class="btn btn-outline-info btn-lg">${categoria.nome}<b
								class="invisivel bola "> ${categoria.quantidadeProdutos}</b></a>
						</div>
					</c:forEach>
				</div>
			</div>
